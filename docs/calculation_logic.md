...
### 重要: 残業は「終了時刻」と「実休憩時間」で判断する

```
実休憩時間 = 1時間 ± 休憩差分
  （例: +0:15 → 実休憩45分、-0:30 → 実休憩1:30）
基準終了時刻 = 開始時刻 + 8時間 + 実休憩時間
残業時間 = 終了時刻 - 基準終了時刻（マイナスなら0）
```

### 例

| 開始 | 終了 | 休憩 | 実休憩 | 基準終了 | 残業 |
|------|------|------|--------|----------|------|
| 4:00 | 13:00 | なし | 1時間 | 13:00 | 0 |
| 4:00 | 13:30 | なし | 1時間 | 13:00 | 30分 |
| 4:00 | 14:00 | 1時間 | 1時間 | 13:00 | 1時間 |
| 4:00 | 14:30 | 1時間 | 1時間 | 13:00 | 1.5時間 |
| 5:00 | 13:45 | +1:00 | 0分 | 13:00 | 45分 |
| 5:00 | 14:30 | -0:30 | 1.5時間 | 14:30 | 0 |
...
- **残業時間の計算に休憩が影響する**
- 実休憩時間が少ない → 基準終了時刻が早くなる → 残業が増える
- 実休憩時間が多い → 基準終了時刻が遅くなる → 残業が減る
