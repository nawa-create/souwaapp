...
export default function OvertimeCalculator() {
  ...
  const calculateOvertime = () => {
    ...
    // 実労働時間
    const actualWorkMinutes = totalMinutes - actualBreakMinutes;
    ...
    // 残業量 = 実労働時間 - 8時間
    const overtimeMinutes = Math.max(0, actualWorkMinutes - STANDARD_WORK);

    // 終了時刻が基準終了時刻を超えているか
    const isOverStandardEnd = workEndMinutes > standardEndMinutes;
